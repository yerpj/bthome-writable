...
const READ_INFO = 0xFE;
const MIC_LEN = 4;
const ENC_OVERHEAD = 4 + MIC_LEN;
const BUDGET = 31 - 3 - 4;
const UUID_TAIL = "-3B0B-4B1A-9E2A-B4C2952E62F2";
const SERVICE_UUID = "2FAA0000" + UUID_TAIL;
const TEXT_TYPES = { text:true };
const EVENT_IDS = { 0x3A:true, 0x3C:true };
...
function handleWrite(k, pl) {
  ...
  try { goFast(); }
  catch (e) { if (st.onError) st.onError(e); }
  return true;
}
