...
async def test_manual_setup_is_refused(hass: HomeAssistant) -> None:
    """Zero-config (rule 4): a MAC entry form would be the first step towards
    the manual configuration that sank the Generic Bluetooth Integration."""
